...
profileApp.controller('appController',['$rootScope', '$scope', '$window', '$location', '$timeout', 'paneFilterService', 'itemFilterService', 'databaseFilterService', 'DatabasesFactory', function($rootScope,$scope,$window,$location,$timeout,paneFilterService,itemFilterService,databaseFilterService,DatabasesFactory) {
