profileApp.controller('ViewUsersController',['$rootScope', '$scope', '$http', '$timeout', '$location', '$window', '$alert', '$filter', 'paneFilterService', 'itemFilterService', 'UsersFactory', 'UserFactory', 'passwdFilter', function($rootScope,$scope,$http,$timeout,$location,$window,$alert,$filter,paneFilterService,itemFilterService,UsersFactory,UserFactory,passwdFilter){
