profileApp.controller('AddDatabaseController',['$scope', '$rootScope', '$http', '$window', '$alert', 'itemFilterService', 'paneFilterService', 'databaseFilterService', 'DatabasesFactory', 'passwdFilter', function($scope,$rootScope,$http,$window,$alert,itemFilterService,paneFilterService,databaseFilterService,DatabasesFactory,passwdFilter){
