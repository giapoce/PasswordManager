profileApp.controller('AddUserController',['$scope', '$rootScope', '$http', '$window', '$alert', 'itemFilterService', 'paneFilterService', 'UsersFactory', 'DatabasesFactory', 'passwdFilter', function($scope,$rootScope,$http,$window,$alert,itemFilterService,paneFilterService,UsersFactory,DatabasesFactory,passwdFilter){
