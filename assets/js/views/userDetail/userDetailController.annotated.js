profileApp.controller('UserDetailController',['$scope', '$http', '$window', '$timeout', '$alert', '$routeParams', 'UsersFactory', 'UserFactory', 'passwdFilter', function($scope,$http,$window,$timeout,$alert,$routeParams,UsersFactory,UserFactory,passwdFilter){
